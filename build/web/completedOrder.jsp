<%-- 
    ...
    Created on : Sep 5, 2022, 2:40:12 PM
    Author     : Legion
--%>
    ...
    <body>
        <c:choose>
            ...
            <c:otherwise>
                ...
                <a href="accountDetail.jsp">Go Back To Personal Page</a>
                            ...
                            <tbody>
                                <c:forEach var="ord" items="${requestScope.completedlist}">
                                    <tr>
                                        ...
                                        <td>Completed</td>
                                        <td><a href="mainController?action=reorder&orderid=${ord.orderID}&page=complete">ReOrder</a></td>
