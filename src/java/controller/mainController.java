...
public class mainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            else if(action.equals("editProfile")) url="editAccountServlet";
            ...
            else if(action.equals("delete")) url="deletetItemServlet";
            else if(action.equals("update")) url="updateCartServlet";
            else if(action.equals("completeOrder")) url="completeOrderServlet";
            else if(action.equals("saveOrder")) url="saveCartServlet";
            ...
            else if(action.equals("editCatePage")) url="editCategory.jsp";
            ...
            else if(action.equals("uploadImage")) url="uploadImageServlet";

            else if(action.equals("updatePlant")) url="updatePlantServlet";
            else if(action.equals("updatePlantPage")) url="updatePlant.jsp";
            else if(action.equals("orderStatusFilter")) url="orderStatusFilterServlet";
