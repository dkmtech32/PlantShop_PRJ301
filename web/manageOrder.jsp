        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <form action="mainController" method="post">
                    ...
                    <input type="hidden" name="action" value="orderStatusFilter">
                </form><br/>
                <c:choose>
                                ...
                                <c:forEach var="order" items="${requestScope.orderList}">
                                    <tr>
                                        ...
                                        <td><c:choose>
                                                ...
                                                <c:when test="${order.status eq 3}">Canceled Order</c:when>
                                            </c:choose></td>
                                        <td>${order.accID}</td>
                                        <td><a href="mainController?action=orderDetail&orderid=${order.orderID}">Check Orders' Detail</a></td>
                                        <td>
